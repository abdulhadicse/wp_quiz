...
<div class="wrap">
    <table class="form-table">
        <tbody>
            <tr>
                <th scope="row">
                    <label for="name"><?php _e( 'Options #1', 'quiz' ); ?></label>
                </th>
                <td>
            ...
            <tr>
                <th scope="row">
                    <label for="address"><?php _e( 'Options #2', 'quiz' ); ?></label>
                </th>
                <td>
            ...
            <tr>
                <th scope="row">
                    <label for="phone"><?php _e( 'Options #3', 'quiz' ); ?></label>
                </th>
                <td>
            ...
            <tr>
                <th scope="row">
                    <label for="phone"><?php _e( 'Options #4', 'quiz' ); ?></label>
                </th>
                <td>
            ...
            <tr>
                <th scope="row">
                    <label for="phone"><?php _e( 'Correct Answer', 'quiz' ); ?></label>
                </th>
                <td>
