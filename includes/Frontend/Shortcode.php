...
class Shortcode {
    ...
    public function __construct() {
        add_shortcode( 'quiz_app', [ $this, 'render_quiz_shorcode' ] );
    }
     ...
     * @return string
     */
    public function render_quiz_shorcode( $atts, $content = '' ) {
        //enqueue scripts
        wp_enqueue_style( 'baseplugin-quiz-tailwind' );
        wp_enqueue_script( 'baseplugin-quiz' );
        
        //localize scripts
        wp_localize_script( 'baseplugin-quiz', 'wpstarter', [ 'ajaxurl' => admin_url( 'admin-ajax.php' ), 'quiz' => $this->get_quiz_questions(), ] );
